% Compare pRF models, Channel Selection
...
modelNames = ["Linear","CSS"];
%   prfmodelModels = {'linear','css','fixexpt'};
%   modelNames = ["Linear","CSS","Fixed Expt"];
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Model Comparison (linear vs css, linear vs fixexpt, css vs fixexpt)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
modelsetsList = nchoosek(1:numel(modelNames),2);
for nn = 1:size(modelsetsList,1)
modelsets = modelsetsList(nn,:);

modelVS = [strjoin(prfmodelModels(modelsets),'VS') '-' gaussianmode];
ecog_APRFF_INITc_postfix;
