...
% 20210914 Yuasa - use ecog_APRFF_00a2_loadoptions
...
ecog_APRF_INITsub_loadoptions;

SetDefault('savePth',fullfile(analysisRootPath, 'Data'));

%% main
[modeldata_a, prf_params_a, xR2fldname, usefulltsxR2] = ecog_prf_loadprfs(subjectList,alphaType,savePth,modeldataID,prfID,average,smoothingMode,smoothingN,prfmodel,gaussianmode,selectchs,selectch_exFEF,selectch_thresh,usefulltsR2,usefulltsxR2,skipsummarizeROIs);
[modeldata_bb, prf_params_bb]                         = ecog_prf_loadprfs(subjectList,broadbandType,savePth,modeldataID,prfID,average,smoothingMode,smoothingN,prfmodel,gaussianmode,selectchs,selectch_exFEF,selectch_thresh,usefulltsR2,usefulltsxR2,skipsummarizeROIs);
